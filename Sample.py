...
# 2. Custom CSS with Droid Serif and Goddard Riverside Colors
st.markdown("""
    <style>
    ...
    .stTabs [data-baseweb="tab"][aria-selected="true"] {
        background-color: #800028 !important;
        border-bottom: 5px solid #FAF7EB !important;
    }
    </style>
...
# ADDED "Project Info" TO THE LIST BELOW
...
with tab4:
    try:
        ...
        st.warning("README.md file not found in the repository.")